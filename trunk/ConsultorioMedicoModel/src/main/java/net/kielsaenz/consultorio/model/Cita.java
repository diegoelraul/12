...
public class Cita extends Bean{
    ...
    @ManyToOne(targetEntity=net.kielsaenz.consultorio.model.Paciente.class, optional=false)
    @JoinColumn(name="pacienteId")
    private Paciente paciente;

    @OneToOne(targetEntity=net.kielsaenz.consultorio.model.Horario.class, optional=false)
